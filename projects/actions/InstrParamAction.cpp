...
#define VS_INSTRPARAM_SELECT \
InstrDAO::getParam(TrackDAO::getInstrument(ProjectDAO::getTrack(ptr, target->track)), target->param)
...
namespace vocalshaper {
	namespace actions {
		namespace instrparam {
			...
			VS_CREATE_OBJECT_SELECT_METHOD_BY_ACTION(selectParam, Param, InstrParamAction, VS_INSTRPARAM_SELECT);
